...
class WeightConverterTest {
    ...
    class KilogramToGramTest{
        @Test
        public void checkIfPointOneKilogramIsEqualToHundredGrams(){
    ...
    class AdditionOfWeights{
        @Test
        public void checkIfAdditionOfTenGramAndIneKilogramGivesThousandAndTenGram(){
...
//    As an architect I want to be able to check if 1 g is
//    equal to 1 g, and 0.1 kg = 100 g, and to know that
//    10 g + 1 kg = 1010 g, and 1.5 kg - 500 g = 1 kg.
